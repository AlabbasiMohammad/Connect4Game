...
def on_click_handler(x, y):
    ...
    if location_in_field(game_field, column):
        ...
        brick_to_drop(game_field, column, raw, turn_Mouse())
        ...
        if check_game_winner(game_field):
            if game_field[raw][column] == 1:
                ...
                make_winning_great_again_1 = input("Enter your name :")
                MovingTurtle.goto(220, 355)
                MovingTurtle.write( make_winning_great_again_1 + " won!" , True, "center", ("Arial", 25, "normal"))
            else:
                print("player 2 won")
                MovingTurtle.goto(200, 380)
